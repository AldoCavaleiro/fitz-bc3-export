...
export default async function handler(req, res) {
  ...
  try {
    ...
    const r = await fetch(`${origin}/api/export-docx-file`, {
      method: 'POST',
    ...
    console.error('export-docx-link error:', e);
    res.status(500).json({ error: 'export-docx-link failed' });
  }
}
