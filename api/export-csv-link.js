...
export default async function handler(req, res) {
  ...
  try {
    ...
    const r = await fetch(`${origin}/api/export-csv-file`, {
      method: 'POST',
    ...
    console.error('export-csv-link error:', e);
    res.status(500).json({ error: 'export-csv-link failed' });
  }
}
