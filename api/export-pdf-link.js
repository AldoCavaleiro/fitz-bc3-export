...
export default async function handler(req, res) {
  ...
  try {
    ...
    const r = await fetch(`${origin}/api/export-pdf-file`, {
      method: 'POST',
    ...
    console.error('export-pdf-link error:', e);
    res.status(500).json({ error: 'export-pdf-link failed' });
  }
}
