...
export default async function handler(req, res) {
  ...
  try {
    ...
    const r = await fetch(`${origin}/api/export-dxf-file`, {
      method: 'POST',
    ...
    console.error('export-dxf-link error:', e);
    res.status(500).json({ error: 'export-dxf-link failed' });
  }
}
