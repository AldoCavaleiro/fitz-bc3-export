...
export default async function handler(req, res) {
  ...
  try {
    ...
    const r = await fetch(`${origin}/api/export-xlsx-file`, {
      method: 'POST',
    ...
    console.error('export-xlsx-link error:', e);
    res.status(500).json({ error: 'export-xlsx-link failed' });
  }
}
